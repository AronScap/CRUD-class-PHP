...
class DB
{
    ...
    public function log_db_errors( $error, $query )
    {
        if (substr($error, 0,15) != 'Duplicate entry') {
            ...
            else trigger_error( $message );
            if( !defined( 'DISPLAY_DEBUG' ) || ( defined( 'DISPLAY_DEBUG' ) && DISPLAY_DEBUG ) )echo $message;
        }
    }
    ...
    public function __construct($db_host_,$db_user_, $db_pass_, $db_name_ )
    {
        ...
        } catch ( Exception $e ){die("ERRORCONNECT");}
    }
    ...
    public function autocommit( $data )
    {
        return $this->link->autocommit( $data );
    }
